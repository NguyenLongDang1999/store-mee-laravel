...
@section('title', __('trans.attribute.manager'))
    ...
    <script>
        ...
        if (dataTable.length) {
            var result = dataTable.DataTable({
                ...
                "sAjaxSource": "{{ route('admin.attribute.getList') }}",
                "bDeferRender": true,
                "bFilter": false,
                "bDestroy": true,
...
@section('content')
    ...
    <h4 class="fw-semibold mb-4 text-uppercase">
        @isset($isRecyclePage)
            {{ __('trans.attribute.manager_recycle') }}
        @else
            {{ __('trans.attribute.manager') }}
        @endisset
    </h4>
    ...
    <div class="row g-4">
        <div class="col-12">
            ...
            @else
                <a href="{{ route('admin.attribute.create') }}" class="btn btn-primary text-capitalize">
                    <span class="ti-xs ti ti-plus me-1"></span>
                    {{ __('trans.btn.create') }}
                </a>

                <a href="{{ route('admin.attribute.recycle') }}" class="btn btn-secondary text-capitalize">
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    {{ html()->form('GET', route('admin.attribute.getList'))->class('row g-3')->id('frmSearch')->attribute('onsubmit', 'return false')->open() }}
                    <div class="col-md-6">
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header border-bottom">
                    <h5 class="card-title mb-0 text-uppercase">{{ __('trans.attribute.list') }}</h5>
                </div>
                ...
                <div class="card-datatable table-responsive">
                    <table class="data_table table border-top nowrap">
                        <thead>
                            <tr>
                                <th></th>
                                <th>{{ __('trans.attribute.title') }}</th>
